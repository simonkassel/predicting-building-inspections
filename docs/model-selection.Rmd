...
# source('R/data-wrangling-and-feature-engineering')
...
round(max(table(ds$o.failed.n)) / nrow(ds), 2)

```

&nbsp;

vel dolor nunc. Nunc ornare justo tellus, ut cursus sapien ultricies vitae.
...
![](../output/plots/machinelearningflashcards_randomForrest.jpg)
...
![*Fig. 1 - Plotting variable Importance*](../output/plots/fig.x-Variable_importance_plot.png)
